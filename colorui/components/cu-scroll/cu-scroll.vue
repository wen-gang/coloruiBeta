...
<template>
	<view
		class="cu-scroll-page"
		:class="[{ 'scroll-y': scrolly }, { 'scroll-x': scrollx }]"
		id="scrollPage"
		:style="[scrolly ? { width: width + 'px' } : { height: height + 'px' }]"
	>
		<scroll-view :scroll-y="scrolly" :scroll-x="scrollx" class="cu-scroll-box" @scroll="_scroll" :scroll-top="toTop">
			<!-- {{toTop}} -->
			<view class="cu-scroll-content" id="scrollContent" :style="[scrolly ? { width: width + 'px' } : { height: height + 'px' }]"><slot></slot></view>
		</scroll-view>

		<view class="cu-scroll-y" v-if="barheight != 0 && scrolly">
			<view
				class="cu-scroll-bar bg-main-a"
		...
		<!-- {{barheight}}, {{scrollx}} -->
		<view class="cu-scroll-x" v-if="barwidth != 0 && scrollx">
			<view
				class="cu-scroll-bar bg-main-a"
