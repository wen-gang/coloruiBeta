<template>
	<view class="ui-popover" :class="popover ? 'show' : 'hide'">
		<view class="ui-popover-button" :id="'popover-button-' + _uid" :style="{ zIndex: index + sys_layer }" @tap="popoverClick" @mouseleave="mouseleave" @mouseover="mouseover">
			<slot></slot>
		</view>
		...
		<view
			...
			:style="{ zIndex: index + sys_layer - 1 }"
			@tap="popover = false"
