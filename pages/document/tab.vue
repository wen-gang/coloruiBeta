<template>
	<ui-sys title="选项卡">
		...
		<view class="paragraph mx-4">选项卡</view>
		...
		<ui-tab :tab="['选项卡1','选项卡2','选项卡3']" tpl="topline"></ui-tab>
		
		<ui-title title="点标记" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1','选项卡2','选项卡3']" tpl="dot"></ui-tab>
		
		<ui-title title="短划线标记" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1','选项卡2','选项卡3']" tpl="long"></ui-tab>
		
		<ui-title title="梯形标记" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1','选项卡2','选项卡3']" tpl="trapezoid"></ui-tab>
		
		<ui-title title="按钮标记" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1','选项卡2','选项卡3']" tpl="btn" mark="bg-red round" curColor="text-white"></ui-tab>
		...
		<view class="p-3 text-center">			
			<ui-tab :tab="['选项卡1','选项卡2','选项卡3','选项卡4','选项卡5','选项卡6','选项卡7']" tpl="btn" mark="ui-BG radius" ui="radius ui-BG-4" inline scroll width="100%"></ui-tab>
		</view>
		<ui-title title="等分" depth="2" isIcon ui="mx-4"></ui-title>
		<view class="px-5"><ui-tab :tab="['选项卡1', '选项卡2', '选项卡3', '选项卡4']" :value="2" align="flex-bar"></ui-tab></view>

		<ui-title title="居中" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1', '选项卡2', '选项卡3']" align="flex-center"></ui-tab>

		<ui-title title="滚动" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab :tab="['选项卡1', '选项卡2', '选项卡3', '选项卡4', '选项卡5', '选项卡6']" scroll></ui-tab>

		<ui-title title="背景" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-tab ui="bg-red" mark="text-white" :tab="['选项卡1', '选项卡2', '选项卡3']" curColor="text-white"></ui-tab>

		<ui-title title="绑定值" depth="2" isIcon ui="mx-4"></ui-title>
		<view class="p-4">data => NavCur:{{ NavCur }}</view>
		<ui-tab :tab="['选项卡1', '选项卡2', '选项卡3']" v-model="NavCur"></ui-tab>
