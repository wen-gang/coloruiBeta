<template>
	<ui-sys title="输入框">
		...
		<ui-form-group ui="ui-BG" title="文本"><ui-input placeholder="请输入文本"></ui-input></ui-form-group>
		...
		<ui-form ui="ui-BG">
			...
			<!-- #ifdef MP -->
			<!-- 输入身份证，调起身份证键盘 -->
			<ui-form-group ui="ui-BG" title="身份证"><ui-input type="idcard" placeholder="请输入身份证"></ui-input></ui-form-group>
			<!-- #endif -->
			<!-- 带小数点的数字键盘 -->
			<ui-form-group ui="ui-BG" title="整数"><ui-input type="digit" placeholder="请输入整数"></ui-input></ui-form-group>
			<!-- 数字输入键盘 -->
			<ui-form-group ui="ui-BG" title="数字"><ui-input type="number" placeholder="请输入数字"></ui-input></ui-form-group>
			<!-- 输入密码 -->
			<ui-form-group ui="ui-BG" title="密码"><ui-input type="password" placeholder="请输入密码"></ui-input></ui-form-group>
		</ui-form>
		<ui-title title="禁用输入框" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-form-group ui="ui-BG" title="文本" disabled><ui-input placeholder="请输入文本"></ui-input></ui-form-group>
		<ui-title title="显示图标" depth="2" isIcon ui="mx-4"></ui-title>

		<ui-form-group ui="ui-BG" title="图标" icon="uicon-safe-check"><ui-input placeholder="请输入文本"></ui-input></ui-form-group>
		<ui-form-group ui="ui-BG" icon="uicon-safe-check"><ui-input placeholder="请输入文本"></ui-input></ui-form-group>
		<ui-form-group ui="ui-BG" title="图标">
		...
		<ui-form-group ui="ui-BG" required icon="uicon-mobile" type="phone"><ui-input placeholder="请输入手机号"></ui-input></ui-form-group>
		<ui-title title="插槽" depth="2" isIcon ui="mx-4"></ui-title>
		<ui-form-group ui="ui-BG" title="短信验证">
		...
		<ui-form-group ui="ui-BG" title="右对齐"><ui-input placeholder="输入框内容右对齐" ui="text-right"></ui-input></ui-form-group>
		<ui-form-group ui="ui-BG" title="居中"><ui-input placeholder="输入框内容居中" ui="text-center"></ui-input></ui-form-group>
